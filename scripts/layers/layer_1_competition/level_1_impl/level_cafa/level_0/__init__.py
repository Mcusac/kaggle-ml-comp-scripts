"""CAFA level_0: base config, paths, ontology, hierarchy, loaders, model manager, embedding paths."""

from .config import CAFAConfig
from .constants import CAFA_ONTOLOGIES, validate_ontology
...
from .t5_loader import load_t5_qs, load_t5_rds
from .threshold_optimization import load_ia_weights, optimize_threshold_ia_weighted
