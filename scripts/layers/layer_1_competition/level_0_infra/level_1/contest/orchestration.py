"""Reusable validate-then-run pattern for contest pipelines returning PipelineResult."""
...
def run_two_stage_pipeline_result_with_validation_first(
    *,
    ...
    This is a small orchestration shell intended for contest implementations to reuse
    without moving any contest-specific policy into infra.
    """
